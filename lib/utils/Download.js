...
/**
 * A CORS proxy.
 * WiseRead uses its own instance of cors-anywhere on heroku.
 *
 ...
 */
export const PROXY_URL = 'https://wiseread-cors.herokuapp.com/'
...
export class Download {
  ...
  async _download (directLink, options) {
    try {
      ...
      const downloadLink = (options.forceProxy) ? PROXY_URL + directLink : directLink
