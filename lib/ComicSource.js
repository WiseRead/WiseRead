...
class DropboxFileLinkLoader extends LinkLoader {
  ...
  async loadDirectLinkAsync () {
    return await DropboxHelp.getDownloadLinkFromFileId(this.dropboxFileInfo.fileId, this.accessToken)
  }

  async loadInitialChapterInfoAsync () {
    return new ChapterInfo({ chapterName: this.dropboxFileInfo.fileName })
  }
}
...
export class ComicSource_DropboxFolder extends ComicSource_DirectLinks {
  ...
  async loadLinkLoaders () {
    ...
    Sort.sortArray(filesInfo, (cl) => cl.fileName)
